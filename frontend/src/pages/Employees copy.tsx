...
export function Employees() {
  ...
  const handleSaveEmployee = (employee: Partial<Employee>) => {
    if (editingEmployee) {
      ...
      const newEmployee = {
        idd: Math.max(...employees.map((e) => e.id)) + 1,
              ...
              <table className="w-full">
                <thead>
                  <tr className="border-b border-gray-200 dark:border-gray-700">
                    <th className="text-left py-3 px-4 text-gray-600 dark:text-gray-400 whitespace-nowrap">
                      Nom
                    </th>
                    <th className="text-left py-3 px-4 text-gray-600 dark:text-gray-400 whitespace-nowrap hidden md:table-cell">
                      Email
                    </th>
                    <th className="text-left py-3 px-4 text-gray-600 dark:text-gray-400 whitespace-nowrap">
                      Poste
                    </th>
                    <th className="text-left py-3 px-4 text-gray-600 dark:text-gray-400 whitespace-nowrap hidden lg:table-cell">
                      Département
                    </th>
                    <th className="text-left py-3 px-4 text-gray-600 dark:text-gray-400 whitespace-nowrap hidden xl:table-cell">
                      Date d'embauche
                    </th>
                    <th className="text-left py-3 px-4 text-gray-600 dark:text-gray-400 whitespace-nowrap">
                      Statut
